...
public class Menus
{
    ...
    static final private String[][] menuPrincipalOpciones = {
                                                               schoolalyzer.tetris.configuracion.Idiomas.iniciarJuego,
                                                               schoolalyzer.tetris.configuracion.Idiomas.opciones,
                                                               schoolalyzer.tetris.configuracion.Idiomas.finalizarJuego
                                                            };
    ...
    static private Menu menuPrincipal = new Menu(menuPrincipalOpciones, menuPrincipalValoresDevueltos, schoolalyzer.tetris.configuracion.PaletaColores.getPaleta(), Menus.menuPrincipalLeft, Menus.menuPrincipalTop);

    static final private String[] textoAlternativoIniciar = schoolalyzer.tetris.configuracion.Idiomas.comienzaJuego;
    ...
    static final private String[] textoAlternativoOpciones = schoolalyzer.tetris.configuracion.Idiomas.modificarOpciones;
    ...
    static final private String[] textoAlternativoFinalizar = schoolalyzer.tetris.configuracion.Idiomas.saleJuego;
    ...
    static final private String[][] menuPrincipalConfirmarSalirOpciones = {
                                                                            schoolalyzer.tetris.configuracion.Idiomas.finalizarJuego,
                                                                            schoolalyzer.tetris.configuracion.Idiomas.volver
                                                                          };
    ...
    static private Menu menuPrincipalConfirmarSalir = new Menu(menuPrincipalConfirmarSalirOpciones, menuPrincipalConfirmarSalirValoresDevueltos, schoolalyzer.tetris.configuracion.PaletaColores.getPaleta(), Menus.menuPrincipalConfirmarSalirLeft, Menus.menuPrincipalConfirmarSalirTop);
    
    static final private String[] textoAlternativoFinalizarSi = schoolalyzer.tetris.configuracion.Idiomas.saleJuego;
    ...
    static final private String[] textoAlternativoFinalizarNo = schoolalyzer.tetris.configuracion.Idiomas.rechazarSalir;
    ...
    static final private String[][] menuPausaOpciones = {
                                                               schoolalyzer.tetris.configuracion.Idiomas.reanudarJuego,
                                                               schoolalyzer.tetris.configuracion.Idiomas.terminarJuego
                                                            };
    ...
    static private Menu menuPausa = new Menu(menuPausaOpciones, menuPausaValoresDevueltos, schoolalyzer.tetris.configuracion.PaletaColores.getPaleta(), Menus.menuPausaLeft, Menus.menuPausaTop);

    static final private String[] textoAlternativoContinuar = schoolalyzer.tetris.configuracion.Idiomas.volverJuego;
    ...
    static final private String[] textoAlternativoTerminar = schoolalyzer.tetris.configuracion.Idiomas.volverMenuPrincipal;
    ...
    static final private String[][] menuPausaConfirmarSalirOpciones = {
                                                                        schoolalyzer.tetris.configuracion.Idiomas.confirmarSalir,
                                                                        schoolalyzer.tetris.configuracion.Idiomas.volver
                                                                      };
    ...
    static private Menu menuPausaConfirmarSalir = new Menu(menuPausaConfirmarSalirOpciones, menuPausaConfirmarSalirValoresDevueltos, schoolalyzer.tetris.configuracion.PaletaColores.getPaleta(), Menus.menuPausaConfirmarSalirLeft, Menus.menuPausaConfirmarSalirTop);
