...
public class Otros
{
    ...
    //General (Modificable):
    static final private String directorioImagenes = "schoolalyzer/tetris/img/"; //Define el directorio de las imagenes.
    static final private String directorioSonido = "schoolalyzer/tetris/snd/"; //Define el directorio de las imagenes.
