...
public class PaletaColores
{
    ...
    static private void setPaleta()
    {
        ...
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroVacio()] = Color.BLACK; //Vacio.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorPanel()] = Color.BLACK; //Fondo del panel.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorPanelTexto()] = Color.MAGENTA; //Texto del panel.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFijo()] = Color.YELLOW; //Texto permamente del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTexto()] = Color.GRAY; //Texto del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondo()] = Color.LIGHT_GRAY; //Fondo del texto del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoSeleccionado()] = Color.GREEN; //Texto seleccionado del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondoSeleccionado()] = Color.WHITE; //Fondo del texto seleccionado del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoAlternativo()] = Color.RED; //Texto alternativo del menu.
        PaletaColores.colores[schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondoAlternativo()] = Color.BLUE; //Fondo del texto alternativo del menu.
