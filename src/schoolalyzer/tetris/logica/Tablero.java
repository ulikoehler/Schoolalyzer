...
public class Tablero
{
    ...
    public final int VACIO = schoolalyzer.tetris.configuracion.Otros.getNumeroVacio(); //Numero que nos marca un vacio (no hay pieza).
    
    protected final int numeroCodificacionPiezas = schoolalyzer.tetris.configuracion.Otros.getNumeroCodificacionPiezas(); //Numero por el que se multiplica cada numero que compone una pieza para insertar el resultado de la operacion en el tablero como piezas ya puestas.
