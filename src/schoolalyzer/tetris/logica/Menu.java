...
public class Menu {
    ...
    protected final int colorTextoFijo = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFijo(); //Numero de color del texto permamente del menu.
    protected final int colorTexto = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTexto(); //Numero de color del texto del menu.
    protected final int colorTextoFondo = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondo(); //Numero de color del fondo del texto del menu.
    protected final int colorTextoSeleccionado = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoSeleccionado(); //Numero de color del texto del menu (cuando una opcion esta seleccionada).
    protected final int colorTextoFondoSeleccionado = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondoSeleccionado(); //Numero de color del fondo del texto del menu (cuando una opcion esta seleccionada).
    protected final int colorTextoAlternativo = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoAlternativo(); //Numero de color del texto alternativo del menu.
    protected final int colorTextoFondoAlternativo = schoolalyzer.tetris.configuracion.Otros.getNumeroColorMenuTextoFondoAlternativo(); //Numero de color de fondo del texto alternativo del menu.
    ...
    public String getTextoAlternativo(int indice) {
        return this.getTextoAlternativo(indice, TetrisMain.getIdiomaActual());
    }
    ...
    public String[] getOpciones() {
        return this.getOpciones(TetrisMain.getIdiomaActual());
    }
    ...
    public int getLeftTextoAlternativoActual() {
        return this.getLeftTextoAlternativo(this.getOpcionActualIndice())[TetrisMain.getIdiomaActual()];
    }

    public int getTopTextoAlternativoActual() {
        return this.getTopTextoAlternativo(this.getOpcionActualIndice())[TetrisMain.getIdiomaActual()];
    }
    ...
    public String getOpcionActualTexto() {
        return this.getOpcionActualTexto(TetrisMain.getIdiomaActual());
    }
    ...
    public void agregarOpcion(String opcion[], String valorRetorno, int indice) {
        ...
        if (indice < 0 || indice > this.numeroOpciones()) {
            return;
        } //Dejamos poner uno mas, por si se quiere agregar al final, despues del ultimo.
    ...
    public int indiceValor(String valorDevuelto) {
        ...
        for (int x = 0; x < this.valoresRetorno.length; x++) {
            ...
            if (valorDevuelto.toUpperCase().equals(valor.toUpperCase())) {
                indice = x;
                break;
            }
        }
