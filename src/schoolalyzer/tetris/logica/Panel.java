...
public class Panel {
    ...
    protected final int colorTexto = schoolalyzer.tetris.configuracion.Otros.getNumeroColorPanelTexto(); //Numero de color del texto del panel.
    protected final int color = schoolalyzer.tetris.configuracion.Otros.getNumeroColorPanel(); //Numero que marca un vacio para el panel (color de fondo del panel).
    protected final int VACIO = schoolalyzer.tetris.configuracion.Otros.getNumeroVacio(); //Numero que marca un vacio para la pieza.
    ...
    public byte[] buscarAnchoAltoMayores(Pieza[] piezasBase) {
        ...
        for (int x = 0; x < piezasBase.length; x++) {
            ...
            if (piezasBase[x].getAlto() > anchoAltoMayores[1]) {
